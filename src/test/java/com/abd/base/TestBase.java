...
public class TestBase {
	...
	public static void setUp() {
		...
		ExcelReader.ExcelInitializer(config.getProperty("excelfilepath"));
...
//		}
//		else {
			driver = WebDriverHandler.getDriver(config.getProperty("browser")); // Earlier There Was No If-Else Condition. This Line Only.
										//If-Else Is Added After We Set Jenkins Parameterization.
//		}
			
			
			
/*	Older Codes, When WebDriverHandler Was Not Created.		
